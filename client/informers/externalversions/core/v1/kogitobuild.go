	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1().KogitoBuilds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1().KogitoBuilds(namespace).Watch(context.TODO(), options)
			},
		},
		&apiv1.KogitoBuild{},
		resyncPeriod,
...
func (f *kogitoBuildInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiv1.KogitoBuild{}, f.defaultInformer)
}

func (f *kogitoBuildInformer) Lister() v1.KogitoBuildLister {
	return v1.NewKogitoBuildLister(f.Informer().GetIndexer())
}
