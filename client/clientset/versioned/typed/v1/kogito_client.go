...
import (
	...
	"github.com/kiegroup/rhpam-kogito-operator/client/clientset/versioned/scheme"
...
// V1Client is used to interact with features provided by the  group.
type V1Client struct {
	restClient rest.Interface
}

func (c *V1Client) KogitoBuilds(namespace string) KogitoBuildInterface {
	return newKogitoBuilds(c, namespace)
}

func (c *V1Client) KogitoRuntimes(namespace string) KogitoRuntimeInterface {
