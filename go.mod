...
replace (
	github.com/kiegroup/kogito-operator => /home/vaibhavjain/RedHatRepo/kogito-operator
	github.com/kiegroup/kogito-operator/api => /home/vaibhavjain/RedHatRepo/kogito-operator/api
)
