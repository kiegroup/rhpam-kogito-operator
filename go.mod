...
replace (
	github.com/kiegroup/kogito-operator => github.com/kiegroup/kogito-operator v0.12.1-0.20210811110055-e7972d9ceb9a
	github.com/kiegroup/kogito-operator/api => github.com/kiegroup/kogito-operator/api v0.0.0-20210811110055-e7972d9ceb9a
	github.com/kiegroup/kogito-operator/client => github.com/kiegroup/kogito-operator/client v0.0.0-20210811110055-e7972d9ceb9a
)
