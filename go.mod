...
require (
	...
	github.com/kiegroup/kogito-operator v0.12.1-0.20210901163740-761552207d27
...
replace github.com/kiegroup/kogito-operator/api => github.com/kiegroup/kogito-operator/api v0.0.0-20210827160405-f6a73130fe0b
