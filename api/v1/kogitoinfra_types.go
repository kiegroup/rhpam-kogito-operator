...
type KogitoInfraStatus struct {
	// +listType=atomic
	// History of conditions for the infra resource
	...
	// +operator-sdk:csv:customresourcedefinitions:type=status,displayName="Runtime Properties"
...
type InfraResource struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=specdisplayName="Name"
...
// +operator-sdk:csv:customresourcedefinitions:displayName="Kogito Infra",resources={{Kafka,kafka.strimzi.io/v1beta2,A Kafka instanc},{Secret,v1,A Kubernetes Secret}}
...
// and link this resource using KogitoInfra to a given Kogito service.
