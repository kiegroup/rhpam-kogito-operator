...
type KogitoServiceStatus struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=status,displayName="Deployment Conditions",xDescriptors="urn:alm:descriptor:io.kubernetes.conditions"
...
type KogitoServiceSpec struct {
	...
	// Defaults to 'false'.
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Insecure Image Registry",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Additional Deployment Labels",xDescriptors="urn:alm:descriptor:com.tectonic.ui:text"
	DeploymentLabels map[string]string `json:"deploymentLabels,omitempty"`

	// Additional labels to be added to the Service managed by the operator.
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Additional Service Labels",xDescriptors="urn:alm:descriptor:com.tectonic.ui:text"
	ServiceLabels map[string]string `json:"serviceLabels,omitempty"`

	// +optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="ConfigMap Properties",xDescriptors="urn:alm:descriptor:com.tectonic.ui:text"
	...
	// +optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Configs",xDescriptors="urn:alm:descriptor:com.tectonic.ui:text"
