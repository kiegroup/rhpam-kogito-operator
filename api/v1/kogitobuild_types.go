...
type KogitoBuildSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="DisableIncremental Builds",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	// +optional
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Runtime",xDescriptors="urn:alm:descriptor:com.tectonic.ui:label"
	// +optional
	...
	// +optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Native Build",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
	...
	// +optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Maven Mirror URL",xDescriptors="urn:alm:descriptor:com.tectonic.ui:label"
	...
	// +optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="Enable Maven Download Output",xDescriptors="urn:alm:descriptor:com.tectonic.ui:booleanSwitch"
...
type KogitoBuildStatus struct {
	...
	// Holds information about the latest build
	...
	// History of builds
	// +operator-sdk:csv:customresourcedefinitions:type=status,displayName="Build History"
...
// +operator-sdk:csv:customresourcedefinitions:displayName="Kogito Build",resources={{BuildConfig,build.openshift.io/v1,A Openshift Build Config},{ImageStream,image.openshift.io/v1, A Openshift Image Stream}}
