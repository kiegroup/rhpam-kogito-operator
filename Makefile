...
BUNDLE_IMG ?= registry.redhat.io/rhpam-7/rhpam-kogito-rhel8-operator-bundle:$(VERSION)
# Default catalog image tag
CATALOG_IMG ?= registry.redhat.io/rhpam-7/rhpam-kogito-rhel8-operator-catalog:$(VERSION)
...
IMG ?= registry.redhat.io/rhpam-7/rhpam-kogito-rhel8-operator:$(VERSION)
