        ...
        stage('Push Operator Image to Openshift Registry') {
            steps {
                sh """
                    ...
                    ${CONTAINER_ENGINE} tag registry.redhat.io/rhpam-7/rhpam-kogito-rhel8-operator:\${TAG_OPERATOR} ${OPENSHIFT_REGISTRY}/openshift/rhpam-kogito-operator:pr-\$(echo \${GIT_COMMIT} | cut -c1-7)
