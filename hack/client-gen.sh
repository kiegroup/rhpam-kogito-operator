...
gen_client() {
  go run k8s.io/code-generator/cmd/client-gen \
    ...
    --input-base=github.com/kiegroup/rhpam-kogito-operator/api \
    --input-dirs=github.com/kiegroup/rhpam-kogito-operator/api/${kogito_api_version} \
    --clientset-name "versioned" \
    --output-base=. \
    --output-package=github.com/kiegroup/rhpam-kogito-operator/client/clientset
...
gen_listers() {
  go run k8s.io/code-generator/cmd/lister-gen \
    ...
    --input-dirs=github.com/kiegroup/rhpam-kogito-operator/api/${kogito_api_version} \
    --output-base=. \
    --output-package=github.com/kiegroup/rhpam-kogito-operator/client/listers
...
gen_informers() {
  go run k8s.io/code-generator/cmd/informer-gen \
    --go-header-file=../hack/boilerplate.go.txt \
    --versioned-clientset-package=github.com/kiegroup/rhpam-kogito-operator/client/clientset/versioned \
    --internal-clientset-package=github.com/kiegroup/rhpam-kogito-operator/client/clientset/versioned \
    --listers-package=github.com/kiegroup/rhpam-kogito-operator/client/listers \
    --input-dirs=github.com/kiegroup/rhpam-kogito-operator/api/${kogito_api_version} \
    --output-base=. \
    --output-package=github.com/kiegroup/rhpam-kogito-operator/client/informers
  error_handler $? "Failed to generate informers"
}

move_gen_code() {
  mv github.com/kiegroup/rhpam-kogito-operator/client/* .
